...
Public Sub Auto_Close()
    ...
    ThisWorkbook.Sheets("INSTRUCTIONS").Visible = xlSheetVisible
...
10. On every close, Auto_Close re-hides department + summary sheets automatically.
